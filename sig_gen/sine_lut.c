...
static uint32_t sine_lut_TEST_B_24[] = {
    0x33221100,0x33221100,0x33221100,0x33221100,0x33221100,0x33221100,0x33221100,0x33221100,
    0x33221100,0x33221100,0x33221100,0x33221100,0x33221100,0x33221100,0x33221100
};

static uint32_t sine_lut_1k_24[] = {
    0x00000000,0x0010b515,0x002120fc,0x0030fbc5,0x00400000,0x004debe5,0x005a827a,0x00658c9a,
    0x006ed9ec,0x007641af,0x007ba375,0x007ee7aa,0x00800000,0x007ee7aa,0x007ba375,0x007641af,
    0x006ed9ec,0x00658c9a,0x005a827a,0x004debe5,0x00400000,0x0030fbc5,0x002120fc,0x0010b515,
    0x00000000,0x00ef4aeb,0x00dedf04,0x00cf043b,0x00c00000,0x00b2141b,0x00a57d86,0x009a7366,
    0x00912614,0x0089be51,0x00845c8b,0x00811856,0x00800000,0x00811856,0x00845c8b,0x0089be51,
    0x00912614,0x009a7366,0x00a57d86,0x00b2141b,0x00c00000,0x00cf043b,0x00dedf04,0x00ef4aeb,
};
...
void lut_gen_init(lut_gen_t *lsg, lut_freq_e freq)
{
    switch (freq) {
        ...
        case LUT_TEST_A_24:
            ...
            break;
        case LUT_TEST_B_24:
            lsg->lut = sine_lut_TEST_B_24;
            lsg->lut_size = sizeof(sine_lut_TEST_B_24)/4;
            break;
        case LUT_FREQ_1k_24:
            lsg->lut = sine_lut_1k_24;
            lsg->lut_size = sizeof(sine_lut_1k_24)/4;
            break;
